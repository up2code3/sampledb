...
RSpec.describe Sample do
  ...
  it "is valid with valid attributes" do
    sample = described_class.new(source_track: source, derived_track: derived)
    expect(sample).to be_valid
  end

  it "is invalid when a track samples itself" do
    sample = described_class.new(source_track: source, derived_track: source)
  ...
  it "is invalid when sampling from the future" do
    sample = described_class.new(source_track: derived, derived_track: source)
    expect(sample).not_to be_valid
